...
"""
        ...
        await query.answer(script.IMDB_MOVIE_2.format(mention=query.from_user.mention, title=imdb.get('title'), genres=imdb.get('genres'), year=imdb.get('year'), rating=imdb.get('rating'), url=imdb['url'], short=imdb['short_info']), show_alert=True)
