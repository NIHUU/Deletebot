...
async def start(client, message):
    ...
    if message.chat.type in ['group', 'supergroup']:
      ...
      [
        ...
        await asyncio.sleep(2) # 😢 https://github.com/NIHUU/Deletebot/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
...
"""
    ...
    if data.split("-", 1)[0] == "BATCH":
        sts = await message.reply("<b>ᴀᴄᴄᴇssɪɴɢ...</b>")
    ...
    if not files_:
        ...
        try:
            ...
            f_caption = f"<code>[CL]{title}</code>"
    ...
    buttons = [
                    [
                        ...
                        InlineKeyboardButton('💞 sʜᴀʀᴇ', url="https://t.me/share/url?url=😱%20CINEMA%20LOOKAM.²·⁰%20😱%0A%0Aഏത്%20അർധരാത്രി%20ചോദിച്ചാലും%20പടം%20കിട്ടും,%20ലോകത്തിലെ%20ഒട്ടുമിക്ക%20ഭാഷകളിലുമുള്ള%20സിനിമകളുടെ%20കളക്ഷൻ..%20❤️%0A%0A👇%20GROUP%20LINK%20👇%0A@CL_FILTER_BOT%0A@CL_FILTER_BOT%0A@CL_FILTER_BOT")
                    ],
                    [
