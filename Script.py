...
🌟 ᴠᴇʀsɪᴏɴ : ᴠ 4.0 [ ʙᴇᴛᴀ ]\n</b>
🔖 𝑸𝒖𝒐𝒕𝒆 : ആരും പേടിക്കേണ്ട എല്ലാവർക്കും  ബോട്ട്  ഉപയോഗിക്കാം"""
...
• ᴜꜱᴇʀɴᴀᴍᴇ : <a href=https://t.me/aboutme_DK>ᴅᴋ</a></b>"""
    OWNER_TXT = f"""<b>🇮🇳 ʜᴇʀᴇ ᴛᴏᴜ ᴄᴀɴ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴏᴡɴᴇʀ 🇮🇳</b>"""
    ENGLISHSPELL_TXT = f"<i><b>𝖲ᴏʀʀʏ 𝖭ᴏ 𝖥ɪʟᴇ𝗌 𝖶ᴇʀᴇ 𝖥ᴏᴜɴᴅ.\n\n𝖢ʜᴇᴄᴋ 𝖸ᴏᴜʀ 𝖲ᴘᴇʟʟɪɴɢ ɪɴ 𝖦ᴏᴏɢʟᴇ ᴀɴᴅ 𝖳ʀʏ 𝖠ɢᴀɪɴ. ♻️\n\n𝖱ᴇᴀᴅ 𝖨ɴ𝗌ᴛʀᴜᴄᴛɪᴏɴ𝗌 ғᴏʀ ʙᴀᴛᴛᴇʀ 𝖱ᴇ𝗌ᴜʟᴛ𝗌 👇🏻</b></i>"
    MAL_TXT = """
...
"""
    ...
    SPELL_TXT = 'ᴄʜᴏᴏsᴇ ᴀ ʟᴀɴɢᴜᴀɢᴇ ғʀᴏᴍ ʙᴇʟᴏᴡ 👇'
